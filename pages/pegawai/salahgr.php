          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <a class="btn btn-primary btn-sm" href="form/tambahGuruF.php">
                ...
                if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        echo "<td><h6>".$row['nip_guru']."</h6></td>";
                        echo "<td><h6>".$row['nama_guru']."</h6></td>";
                        echo "<td><h6>".$row['alamat_guru']."</h6></td>";
                        echo "<td><h6>".$row['agama_guru']."</h6></td>";
                        echo "<td><h6>".$row['no_telp_guru']."</h6></td>";
                        echo "<td><h6>".$row['jk_guru']."</h6></td>";
                        echo "<td><h6>".$row['tmp_lahir_guru']."</h6></td>";
                        echo "<td><h6>".$row['tgl_lahir_guru']."</h6></td>";
                        echo "<td><h6>".$row['username_g']."</h6></td>";
                        echo "<td><h6>".$row['password_g']."</h6></td>";
                        echo "<td>";
