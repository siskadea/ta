                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../indexsw.php">SiakadK13</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-success">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form role="form" action="../controller/tambahSiswa.php" method="POST">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <!-- text input -->
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>ID Ortu</label>
                                                    <input type="text" class="form-control" name="id_ortu" require>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Nama</label>
                                                    <input type="text" class="form-control" name="nama_siswa" require>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <!-- select -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="tmp_lahir" require>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Alamat</label>
                                                    <input type="text" class="form-control" name="alamat_siswa" require>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Username</label>
                                                    <input type="text" class="form-control" name="username_s" require>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Password</label>
                                                    <input type="text" class="form-control" name="password_s" require>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
