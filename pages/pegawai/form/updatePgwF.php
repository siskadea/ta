        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../indexpgw">SiakadK13</a></li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <?php
                ...
                ?>
                <form role="form" action="../controller/updatePgw.php" method="POST">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        <label>NIP</label>
                        <input type="text" class="form-control" name="nip_pegawai" value="<?php echo $row["nip_pegawai"]; ?>">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="notelp_pegawai" value="<?php echo $row["notelp_pegawai"]; ?>">
                      </div>
                    </div>
                  </div><!-- row 2 -->
                  <div class="row">
                  <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="jk_pegawai" value="<?php echo $row["jk_pegawai"]; ?>">
                ...
                <div class="col-sm-4">
                        <div class="form-group">
                        <label>Agama</label>
                        <select class="form-control" name="agama_pegawai" value="<?php echo $row["agama_pegawai"]; ?>">
                          <option>Islam</option>
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        <label>Alamat</label>
                        <input type="text" class="form-control" name="alamat_pegawai" value="<?php echo $row["alamat_pegawai"]; ?>">
                ...
                <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tmp_lahir_pegawai" value="<?php echo $row["tmp_lahir_pegawai"]; ?>">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Tanggal lahir</label>
                        <input type="date" class="form-control" name="tgl_lahir_pegawai" value="<?php echo $row["tgl_lahir_pegawai"]; ?>">
                      </div>
                    </div>
                    </div>
                <!-- </div> -->
                <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="username_pegawai" value="<?php echo $row["username_pegawai"]; ?>">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Password</label>
                        <input type="text" class="form-control" name="password_pegawai" value="<?php echo $row["password_pegawai"]; ?>">
                      </div>
                    </div>
                  </div><!-- row 4 -->  
                  <div class="row">
