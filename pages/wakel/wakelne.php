                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview menu-open">
                            <a href="indexwakel.php" class="nav-link active">
                                <i class="nav-icon fas fa-home"></i>
                                <p>Beranda</p>
                            </a>
                        </li>
                        <li class="nav-item has-treeview menu-open">
                            <a href="indexwakel.php" class="nav-link">
                                <i class="nav-icon fas fa-copy"></i>
                                <p>Nilai<i class="right fas fa-angle-left"></i></p>
                            </a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="wakelns.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Sikap</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="wakelne.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Ekstra</p>
                                    </a>
                                </li>
                        ...
                        echo '<a href=../../proses/logout.php>logout</a>';
                    </ul>
                </nav>
                <!-- /.sidebar-menu -->
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <!-- <a class="btn btn-primary btn-sm" href="tambahSensorF.php">
                ...
                <br>
                <?php
                $query = "SELECT np.id_np, np.nis, np.kkm_np, np.nilai_np, np.predikat_np, np.tahun_ajaran,
                          np.semester, m.nama_mapel, d.deskripsi, s.nama_siswa
                          FROM nilai_pengetahuan np JOIN mapel m ON np.id_mapel=m.id_mapel
                          JOIN deskripsi_nilai d ON np.id_deskripsi=d.id_deskripsi
                          JOIN siswa s ON np.nis=s.nis";
                ...
                if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        echo "<td><h6>".$row['kkm_np']."</h6></td>";
                        echo "<td><h6>".$row['nilai_np']."</h6></td>";
                        echo "<td><h6>".$row['predikat_np']."</h6></td>";
                        echo "<td><h6>".$row['deskripsi']."</h6></td>";
                        echo "<td><h6>".$row['tahun_ajaran']."</h6></td>";
                        echo "<td><h6>".$row['semester']."</h6></td>";
                        echo "<td>";
                        echo "<a  href='form/tambahnpF.php'>
                            <span class='glyphicon glyphicon-plus'>Add</span>
                            </a>";
            						echo "<a  href='form/updatenpF.php?id=".$row["id_np"]."'>
                            <span class='glyphicon glyphicon-plus'>Update</span>
                            </a>";
                        echo "   ";
                        echo "<a  href='controller/deletenp.php?id=".$row["id_np"]."'>
