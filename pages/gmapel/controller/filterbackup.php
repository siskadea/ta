...
<body>
                    ...
                    if (isset($_POST["x"])) {
                        ...
                        if(mysqli_num_rows($result) > 0){
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                data-toggle='modal' data-target='#tambahNilaiForm'>Tambah Nilai</button></td>";
                                // echo "</tr>";
                            }   
                        }
                    }  
    ...
    <div class="modal fade" id="tambahNilaiForm" tabindex="-1" role="dialog" data-backdrop="dinamyc"
        data-keyboard="false">
                ...
                <div class="col-12">
                    <table class="table table-bordered table-stripped">
                        <thead>
                            ...
                            <th>Nama</th>
                            <th>LP</th>
                            <th>N-1</th><th>N-2</th><th>N-3</th><th>N-4</th><th>N-5</th>
                            <th>N-6</th><th>N-7</th><th>N-8</th><th>HP TS</th><th>HP AS</th>
                        </thead>
                        <tr>
                            <td><?php 
                                $qw = "SELECT s.nis
