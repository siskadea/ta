          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Update Nilai Keterampilan</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <?php
                $id =$_GET["id"];
                $query = "SELECT * FROM nilai_keterampilan WHERE id_nk=$id";
                $result = mysqli_query($koneksi, $query);    
                if(mysqli_num_rows($result) == 1) {
                $row = mysqli_fetch_assoc($result);
                ?>
                <form role="form" action="../controller/updatenk.php" method="POST">
                  <div class="row">
                    <div class="col-sm-4">
                      <input type="hidden" name="id_nk" value="<?php echo $row["id_nk"]; ?>">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        <label>KKM</label>
                        <input type="text" class="form-control" name="kkm_nk" value="<?php echo $row["kkm_nk"]; ?>">
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="form-group">
                        <label>Nilai</label>
                        <input type="text" class="form-control" name="nilai_nk" value="<?php echo $row["nilai_nk"]; ?>">
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="form-group">
                        <label>Predikat</label>
                        <select class="form-control" name="predikat_nk" value="<?php echo $row["predikat_nk"]; ?>">
                ...
                <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <a class="btn btn-danger" href="../gmapelnk.php">Batal</a>
                  </div>
                </form>
