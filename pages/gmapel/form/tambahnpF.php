                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-success">
                            <div class="card-header">
                                <h3 class="card-title">Tambah Nilai Pengetahuan</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form role="form" action="../controller/tambahnp.php" method="POST">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <!-- text input -->
                                            <div class="form-group">
                                                <label>ID Nilai Pengetahuan</label>
                                                <input type="text" class="form-control" name="id_np" require>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <!-- text input -->
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>KKM</label>
                                                <input type="text" class="form-control" name="kkm_np" require>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Nilai</label>
                                                <input type="text" class="form-control" name="nilai_np" require>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Predikat</label>
                                                <select class="form-control" name="predikat_np">
