                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="../gmapelnp.php">Home</a></li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Update Nilai Pengetahuan</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <?php
                $id =$_GET["id"];
                $query = "SELECT * FROM nilai_pengetahuan WHERE id_np=$id";
                $result = mysqli_query($koneksi, $query);    
                if(mysqli_num_rows($result) == 1) {
                $row = mysqli_fetch_assoc($result);
                ?>
                <form role="form" action="../controller/updatenp.php" method="POST">
                  <div class="row">
                    <div class="col-sm-4">
                      <input type="hidden" name="id_np" value="<?php echo $row["id_np"]; ?>">
                      <div class="form-group">
                        <label>Mata Pelajaran</label>
                        <select class="form-control" name="id_mapel" value="<?php echo $row["id_mapel"]; ?>">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        <label>KKM</label>
                        <input type="text" class="form-control" name="kkm_np" value="<?php echo $row["kkm_np"]; ?>">
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="form-group">
                        <label>Nilai</label>
                        <input type="text" class="form-control" name="nilai_np" value="<?php echo $row["nilai_np"]; ?>">
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="form-group">
                        <label>Predikat</label>
                        <select class="form-control" name="predikat_np" value="<?php echo $row["predikat_np"]; ?>">
                ...
                <div class="row">
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="id_deskripsi" value="<?php echo $row["id_deskripsi"]; ?>">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>Tahun Ajaran</label>
                        <input type="text" class="form-control" name="tahun_ajaran" value="<?php echo $row["tahun_ajaran"]; ?>">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
