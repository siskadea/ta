                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview menu-open">
                            <a href="indexgbp.php" class="nav-link">
                                <i class="nav-icon fas fa-home"></i>
                                <p>Beranda</p>
                            </a>
                        </li>
                        <li class="nav-item has-treeview menu-open">
                            <a href="pelanggaran.php" class="nav-link active">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="../pelanggaran.php">SiakadK13</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-success">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form role="form" action="../controller/tambahPelanggaran.php" method="POST">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <!-- text input -->
                                            <div class="form-group">
                                                <label>ID Pelanggaran</label>
                                                <input type="text" class="form-control" name="id_pelanggaran" require>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <!-- text input -->
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="ket" require>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Tahun Ajaran</label>
                                                <input type="text" class="form-control" name="tahun_ajar" require>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-danger" href="../pelanggaran.php">Batal</a>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card-body -->
